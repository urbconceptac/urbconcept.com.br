...
import { WhatsAppFloat } from "@/components/urb/WhatsAppFloat";
          ...
          <div className="relative mx-auto grid w-full max-w-[1200px] gap-12 px-6 py-20 lg:grid-cols-12">
            <div className="lg:col-span-8">
              ...
              <Button
                asChild
                size="lg"
                className="mt-10 rounded-none bg-whatsapp font-mono text-[11px] uppercase tracking-[0.18em] text-whatsapp-foreground hover:bg-whatsapp/90"
              >
            ...
            <div className="grid gap-12 lg:grid-cols-12">
              <div className="lg:col-span-4">
                ...
                <Button
                  asChild
                  size="lg"
                  className="mt-8 w-full rounded-none bg-whatsapp font-mono text-[11px] uppercase tracking-[0.18em] text-whatsapp-foreground hover:bg-whatsapp/90 sm:w-auto"
                >
                  <a href={whatsappLink()} target="_blank" rel="noreferrer noopener">
                    <MessageCircle className="mr-2 h-4 w-4" strokeWidth={2} />
