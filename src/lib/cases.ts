...
const STORAGE_KEY = "urb-custom-cases";
const OVERRIDES_KEY = "urb-case-overrides";
const HIDDEN_KEY = "urb-case-hidden";
...
export function useCases() {
  ...
  return { cases, custom, hidden, addCase, removeCase, restoreCase, updateCase };
}
